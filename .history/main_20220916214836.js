$(document).ready(function() {
    ...
    function ActiveNavItem() {
        ...
        document.onscroll = () => {
            scroll =document.documentElement.scrollTop +10
            for (item of mainItem) {
                    var positionOfItem = item.offsetTop
                    var positionOfNextItem =  item.offsetTop + item.offsetHeight
                if (scroll > positionOfItem && scroll < topAddHeightOfItem && po) {
                    console.dir(item)
                    console.log(scroll)
                }
                console.log('item',positionOfItem, topAddHeightOfItem)
